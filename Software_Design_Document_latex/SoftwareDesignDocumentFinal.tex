...
\usepackage{graphicx}
\graphicspath{{/home/sujoy/Downloads/FinalDiagrams/}}
...
\begin{figure}[h!]
\centering
\includegraphics[height=0.77\textheight,keepaspectratio]{u.jpg}
...
\end{itemize}
\end{enumerate}
\newgeometry{left=0.13cm,right=0.13cm,bottom=1cm,top=1cm}
\chapter{Sequence Diagram}
\begin{figure}[h!]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{ua.jpg}
\caption{Sequence Diagram : SignUp}
\end{figure}
\newpage
\begin{figure}[h!]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{ub.jpg}
\caption{Sequence Diagram : Login}
\end{figure}
\newpage
\begin{figure}[h!]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{uc.jpg}
\caption{Sequence Diagram : Add Student Record}
\end{figure}
\begin{figure}[h!]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{ud.jpg}
\caption{Sequence Diagram : Edit Student Record}
\end{figure}
\newpage
\begin{figure}
\centering
\includegraphics[width=\textwidth,keepaspectratio]{ue.jpg}
\caption{Sequence Diagram : Delete Student Record}
\end{figure}
\begin{figure}
\centering
\includegraphics[width=\textwidth,keepaspectratio]{uf.jpg}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth,keepaspectratio]{ug.jpg}
...
\begin{figure}[h!]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{cd.jpg}
\caption{Class Diagram}
\end{figure}
\newpage
\begin{figure}[h!]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{cd1.jpg}
\caption{Class Summary}
\end{figure}
\newpage
\begin{figure}[h!]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{cd2.jpg}
\caption{Class Summary}
\end{figure}
